  ...
  return (
    <section className="bg-surface-lowest py-section" id="contact">
      <div className="section-container grid items-start gap-16 lg:grid-cols-[1fr_0.85fr] lg:gap-28">
        ...
        <form className="grid animate-fade-up gap-5 border-t-4 border-gold bg-surface-container p-6 shadow-card [animation-delay:160ms] md:p-12" aria-label="Contact inquiry form">
