  ...
  return (
    <section className="bg-surface py-section">
      <div className="section-container grid items-center gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:gap-32">
        <div className="corner-frame group relative min-h-[420px] animate-fade-up overflow-hidden bg-office-lines bg-[length:44px_100%,100%_100%] shadow-card" aria-label="Luxury office meeting room">
          <div className="absolute left-[14%] top-[8%] h-3/4 w-[72%] bg-gradient-to-r from-transparent via-white/10 to-transparent transition duration-700 group-hover:via-gold/10" />
