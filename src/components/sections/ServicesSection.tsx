      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-16 md:grid-cols-4 md:gap-y-24">
          {services.map((service) => {
            ...
            return (
              <article className="group flex animate-fade-up flex-col items-center gap-6 text-center" key={service.label}>
                <Icon className="h-9 w-9 text-zinc-300 opacity-80 transition duration-300 group-hover:-translate-y-1 group-hover:scale-110 group-hover:text-gold group-hover:opacity-100" aria-hidden="true" />
