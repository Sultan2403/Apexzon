      ...
      <div className="section-container">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {processSteps.map((step) => {
            ...
            return (
              <article
                className={`grid min-h-72 animate-fade-up grid-cols-[auto_1fr] gap-4 border border-outline bg-background/50 p-8 transition duration-500 hover:-translate-y-1 hover:border-l-gold hover:shadow-gold-soft max-sm:grid-cols-1 ${
