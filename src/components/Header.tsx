...
export function Header() {
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex h-[74px] animate-fade-up items-center justify-between border-b border-outline bg-background/75 px-gutter shadow-[0_10px_40px_rgba(0,0,0,0.22)] backdrop-blur-lg md:h-[74px]">
